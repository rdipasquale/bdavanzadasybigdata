package ar.edu.uca.bd.template.test;

import ar.edu.uca.bd.template.ApplicationTest;
import ar.edu.uca.bd.template.domain.Movie;
import ar.edu.uca.bd.template.domain.Person;
import ar.edu.uca.bd.template.domain.Role;
import ar.edu.uca.bd.template.repositories.MovieRepository;
import ar.edu.uca.bd.template.repositories.PersonRepository;
